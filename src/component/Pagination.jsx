    ...
    <div className="bg-white py-10 text-center ">
      <div className="inline-flex gap-1 rounded-full border border-stroke p-3 ">
        <ul className="flex items-center gap-1">
          <li>
            <button className="flex h-10 min-w-10 items-center justify-center rounded-full px-2 text-dark hover:bg-gray-2">
              <svg
                width="20"
                height="21"
                viewBox="0 0 20 21"
          ...
          <li>
            <button className="flex h-10 min-w-10 items-center justify-center rounded-full bg-primary px-2 text-dark hover:bg-gray-2">
              2
            </button>
          </li>
          <li>
